...
##--your-code-starts-here--##
F_man = np.ones(man.shape)  # replace me
F_man_lowpass = np.ones(man.shape)  # replace me
F_wolft = np.ones(man.shape)  # replace me
F_wolft_highpass = np.ones(man.shape)  # replace me
##--your-code-ends-here--##
