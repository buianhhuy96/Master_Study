...
Y = reshape((I2.yy), [I2.rows I2.cols]);
U = imresize(reshape((I2.uu), [I2.rows/2 I2.cols/2]),2);
V = imresize(reshape((I2.vv), [I2.rows/2 I2.cols/2]),2);
...
r = reshape(shaped_RGB(1,:),[I2.rows I2.cols]);
g = reshape(shaped_RGB(2,:),[I2.rows I2.cols]);
b = reshape(shaped_RGB(3,:),[I2.rows I2.cols]);
RGB = cat(3,r,g,b);
f2 = figure('Name', 'RGB');
